...
<template>
        <div class="registration-body flex justify-center position-relative b-rd-10 main-background-color mt-10 mb-10">
          ...
          <div class="registration">
            ...
            <p class="login text-color-white underline text-center mt-16 mb-24 mr-20 font-size-6 main-background-color">
